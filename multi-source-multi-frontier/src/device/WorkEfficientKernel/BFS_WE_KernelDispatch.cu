...
#define fun(a)		BFS_KernelMainDEV<BlockDim, (a), true, DUP_REM>\
						(devNodes, devEdges, colors, devF1, devF2, FrontierSize, level);

#define funB(a)		BFS_KernelMainDEVB	<BLOCKDIM, (a), true, DUP_REM>\
						(devNodes, devEdges, colors, devF1, devF2, FrontierSize, level);
...
__global__ void BFSDispath(	int*    __restrict__ devNodes,
	...
	int FrontierSize = NUM_SOURCES, level = 1;
	do {
