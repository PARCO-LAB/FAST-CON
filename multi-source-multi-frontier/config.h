...
#include <limits>
		   ...
		   const int N_OF_TESTS  =	10;	// NUMBER OF TESTS
#define                  NUM_SM         16
#define          MAX_CONCURR_TH		(NUM_SM * 2048)	// Number of Resident Threads
#define	               BLOCKDIM		1024		// (important: >= 256 for INTER_BLOCK_SYNC=1)
           //important BLOCKDIM = POWER OF 2
#define             NUM_SOURCES         MAX_CONCURR_TH/BLOCKDIM // The number of sources from where to start the concurrent BFS visits
#define              NUM_BLOCKS         MAX_CONCURR_TH/BLOCKDIM
#define                DEEPNESS         3               // Percentage to visit at each step
#define       SOURCES_PER_BLOCK         1
#define           SHARED_MEMORY         1000000
